...
def main():
    ...
    save_dir = 'outputs/deepseek'  # Define save directory for HippoRAG objects (each LLM/Embedding model combination will create a new subdirectory)
    llm_model_name = 'deepseek-chat'  # Any OpenAI model name
